...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dataFetcher_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataFetcher.js */ \"./src/dataFetcher.js\");\n/* harmony import */ var _jsonProcessor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jsonProcessor.js */ \"./src/jsonProcessor.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\n\n\n\n\n_jsonProcessor_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].processWeatherData('london');\n\nconst uiController = (() => {\n\n    \n    const writeMain = (content) => {\n        let main = document.createElement('div');\n        main.setAttribute('id', 'main');\n        content.appendChild(main);\n        writeDefault();\n    }\n\n    const clearMain = () => {\n        let main = document.getElementById('main');\n            while (main.firstChild) {\n                main.removeChild(main.firstChild);\n            } \n    }\n\n    const writeForm = () => {\n\n    }\n\n})();\n\n\n//# sourceURL=webpack://weather-api/./src/index.js?");
